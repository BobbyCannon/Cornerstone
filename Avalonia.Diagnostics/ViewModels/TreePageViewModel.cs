...
public class TreePageViewModel : ViewModel, IDisposable
{
	#region Fields
	...
	public TreePageViewModel(MainViewModel mainView, TreeNode[] nodes, ISet<string> pinnedProperties)
	{
		...
		PropertiesFilter.RefreshFilter += (s, e) => Details?.Properties?.RefreshFilter();
	...
	public TreeNode SelectedNode
	{
		...
		set
		{
			...
			{
				Details = value != null ? new ControlDetailsViewModel(this, value.Visual, _pinnedProperties) : null;
