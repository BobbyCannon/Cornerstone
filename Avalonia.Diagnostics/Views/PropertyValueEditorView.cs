...
public class PropertyValueEditorView : UserControl
{
	#region Fields
	...
	private Control UpdateControl()
	{
		...
		if (propertyType.IsEnum)
		{
			return CreateControl<ComboBox>(
				SelectingItemsControl.SelectedItemProperty, init: c => { c.ItemsSource = Enum.GetValues(propertyType); });
		}
	...
	private static class StringConversionHelper
	{
		...
		public static object FromString(string str, Type type)
		{
			...
			return converter.CanConvertFrom(typeof(string)) ? converter.ConvertFrom(null, CultureInfo.InvariantCulture, str) : InvokeParse(str, type);
		}
		...
		private static object InvokeParse(string s, Type targetType)
		{
			...
			return m.Invoke(null,
				hasFormat ? [s, CultureInfo.InvariantCulture] : [s]);
		}
