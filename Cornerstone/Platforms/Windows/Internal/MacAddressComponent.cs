...
/// </summary>
internal class MacAddressComponent : DeviceIdComponent
{
	#region Fields
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="MacAddressComponent" /> class.
	/// </summary>
	...
	public MacAddressComponent(bool excludeWireless, bool excludeNonPhysical)
	{
