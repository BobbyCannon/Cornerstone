...
public class AndroidPlatformCredentialVault : PlatformCredentialVault
{
	#region Constructors

	public AndroidPlatformCredentialVault(IRuntimeInformation runtimeInformation, IDispatcher dispatcher)
