...
/// <summary>
/// Exposes static methods that can be used as math utility methods for common math
/// operations related with input processing.
/// </summary>
public static class InputMath
{
	...
	/// </summary>
	/// <param name="value">
	/// A number between -1 and 1, representing
	/// the position of an axis.
	/// </param>
	/// <param name="innerDeadZone">
	/// A value between 0 and 1
	/// representing the inner portion of the axis that is in
	/// the dead-zone.
	/// </param>
	/// <param name="outerDeadZone">
	/// A value between 0 and 1
	/// representing the outer portion of the axis that is in
	/// the dead-zone.
	/// </param>
	/// <returns>
	/// A number between 0 and 1, if <paramref name="value" />
	/// is positive, or between -1 and 0 if <paramref name="value" /> is
	/// negative, which results from applying the inner and outer
	/// dead-zones to <paramref name="value" />.
	/// </returns>
	/// <exception cref="ArgumentException">
	/// <paramref name="value" /> is <see cref="float.NaN" />.
	/// </exception>
	/// <exception cref="ArgumentException">
	/// <paramref name="innerDeadZone" /> is <see cref="float.NaN" />.
	/// </exception>
	/// <exception cref="ArgumentException">
	/// <paramref name="outerDeadZone" /> is <see cref="float.NaN" />.
	/// </exception>
	/// <remarks>
		...
		float innerDeadZone, float outerDeadZone)
	{
		...
		{
			throw new ArgumentException($"'{float.NaN}' is not a valid value for '{nameof(value)}' parameter.", nameof(value));
		}
		if (float.IsNaN(innerDeadZone))
		{
			throw new ArgumentException($"'{float.NaN}' is not a valid value for '{nameof(innerDeadZone)}' parameter.", nameof(innerDeadZone));
		}
		if (float.IsNaN(outerDeadZone))
		{
			throw new ArgumentException($"'{float.NaN}' is not a valid value for '{nameof(outerDeadZone)}' parameter.", nameof(outerDeadZone));
		}

		var isNegativeValue = value < 0f;
	...
	/// <returns>
	/// 0 if <paramref name="value" /> is lower than or equal to 0,
	...
	/// <param name="value"> A <see cref="float" /> value to truncate. </param>
	/// <returns>
	/// -1 if <paramref name="value" /> is lower than or equal to -1,
	/// 1 if <paramref name="value" /> is greater than or equal to 1,
	/// or <paramref name="value" />.
	/// </returns>
	/// <exception cref="ArgumentException">
	...
	/// A <see cref="float" /> number
	/// representing the normalized angle.
	/// </param>
	/// <returns>
	/// The representation of <paramref name="normalAngle" />
	/// in radians.
	/// </returns>
	/// <exception cref="ArgumentException">
	/// <paramref name="normalAngle" />
	...
	public static float ConvertNormalToRadians(float normalAngle)
	{
		...
		{
			throw new ArgumentException($"'{normalAngle}' is not a valid value for '{nameof(normalAngle)}' parameter.", nameof(normalAngle));
		}
	...
	/// <returns>
	/// A number between 0 and 1 representing the normalized
	/// <paramref name="angle" />. See remarks for more details.
	/// </returns>
	/// <exception cref="ArgumentException">
	/// <paramref name="angle" /> is <see cref="float.NaN" />.
	/// </exception>
	/// <remarks>
	...
	public static float ConvertRadiansToNormal(float angle)
	{
		...
		{
			throw new ArgumentException($"'{float.NaN}' is not a valid value for '{nameof(angle)}' parameter.", nameof(angle));
		}
	...
	/// <param name="x">
	/// Variable that will be set with the
	/// converted X Cartesian coordinate.
	/// </param>
	/// <param name="y">
	/// Variable that will be set with the
	/// converted Y Cartesian coordinate.
	/// </param>
	/// <exception cref="ArgumentException">
	/// <paramref name="angle" /> is <see cref="float.NaN" />.
	/// </exception>
	/// <exception cref="ArgumentException">
	/// <paramref name="radius" /> is <see cref="float.NaN" />.
	/// </exception>
	/// <remarks>
	/// <p>
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void ConvertToCartesian(float angle, float radius, out float x, out float y)
	{
		if (float.IsNaN(angle))
		{
			throw new ArgumentException($"'{float.NaN}' is not a valid value for '{nameof(angle)}' parameter.", nameof(angle));
		...
		{
			throw new ArgumentException($"'{float.NaN}' is not a valid value for '{nameof(radius)}' parameter.", nameof(radius));
		}
	...
	/// <param name="angle">
	/// Variable that will be set with the
	/// converted angle coordinate, in radians.
	/// </param>
	/// <param name="radius">
	/// Variable that will be set with
	/// the converted radius coordinate.
	/// </param>
	/// <exception cref="ArgumentException">
	/// <paramref name="x" /> is <see cref="float.NaN" />.
	/// </exception>
	/// <exception cref="ArgumentException">
	/// <paramref name="y" /> is <see cref="float.NaN" />.
	/// </exception>
	/// <remarks>
	/// <p>
	...
	/// <seealso cref="ConvertRadiansToNormal(float)" />
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static void ConvertToPolar(float x, float y, out float angle, out float radius)
	{
		if (float.IsNaN(x))
		{
			throw new ArgumentException($"'{float.NaN}' is not a valid value for '{nameof(x)}' parameter.", nameof(x));
		}
		if (float.IsNaN(y))
		{
			throw new ArgumentException($"'{float.NaN}' is not a valid value for '{nameof(y)}' parameter.", nameof(y));
		}
	...
	/// specifying the interpolation amount to apply.
	/// </param>
	/// <returns>
	/// The result of the interpolation between
	...
	public static float Interpolate(float x, float y, float interpolation)
	{
		...
		{
			throw new ArgumentException($"'{float.NaN}' is not a valid value for '{nameof(interpolation)}' parameter.", nameof(interpolation));
		}
