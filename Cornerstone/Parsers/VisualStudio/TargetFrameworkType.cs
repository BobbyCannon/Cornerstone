...
public enum TargetFrameworkType
{
	...
	[TargetFramework(Moniker = "net8.0", Version = "8.0", NetStandard = NetStandard21, Platform = Net8, Parent = Net9)]
	Net8,

	[TargetFramework(Moniker = "net8.0-android", Version = "8.0", OperatingSystem = "android", NetStandard = NetStandard21, Platform = Net8, Parent = Net9Android)]
	Net8Android,

	[TargetFramework(Moniker = "net8.0-browser", Version = "8.0", OperatingSystem = "browser", NetStandard = NetStandard21, Platform = Net8, Parent = Net9Browser)]
	Net8Browser,

	[TargetFramework(Moniker = "net8.0-ios", Version = "8.0", OperatingSystem = "ios", NetStandard = NetStandard21, Platform = Net8, Parent = Net9Ios)]
	Net8Ios,

	[TargetFramework(Moniker = "net8.0-maccatalyst", Version = "8.0", OperatingSystem = "maccatalyst", NetStandard = NetStandard21, Platform = Net8, Parent = Net9MacCatalyst)]
	Net8MacCatalyst,

	[TargetFramework(Moniker = "net8.0-macos", Version = "8.0", OperatingSystem = "macos", NetStandard = NetStandard21, Platform = Net8, Parent = Net9MacOs)]
	Net8MacOs,

	[TargetFramework(Moniker = "net8.0-tvos", Version = "8.0", OperatingSystem = "tvos", NetStandard = NetStandard21, Platform = Net8, Parent = Net9TvOs)]
	Net8TvOs,

	[TargetFramework(Moniker = "net8.0-windows", Version = "8.0", OperatingSystem = "windows", NetStandard = NetStandard21, Platform = Net8, Parent = Net9Windows)]
	Net8Windows,

	[TargetFramework(Moniker = "net9.0", Version = "9.0", NetStandard = NetStandard21, Platform = Net9)]
	Net9,
	
	[TargetFramework(Moniker = "net9.0-android", Version = "9.0", OperatingSystem = "android", NetStandard = NetStandard21, Platform = Net9)]
	Net9Android,

	[TargetFramework(Moniker = "net9.0-browser", Version = "9.0", OperatingSystem = "browser", NetStandard = NetStandard21, Platform = Net9)]
	Net9Browser,

	[TargetFramework(Moniker = "net9.0-ios", Version = "9.0", OperatingSystem = "ios", NetStandard = NetStandard21, Platform = Net9)]
	Net9Ios,

	[TargetFramework(Moniker = "net9.0-maccatalyst", Version = "9.0", OperatingSystem = "maccatalyst", NetStandard = NetStandard21, Platform = Net9)]
	Net9MacCatalyst,

	[TargetFramework(Moniker = "net9.0-macos", Version = "9.0", OperatingSystem = "macos", NetStandard = NetStandard21, Platform = Net9)]
	Net9MacOs,

	[TargetFramework(Moniker = "net9.0-tvos", Version = "9.0", OperatingSystem = "tvos", NetStandard = NetStandard21, Platform = Net9)]
	Net9TvOs,

	[TargetFramework(Moniker = "net9.0-windows", Version = "9.0", OperatingSystem = "windows", NetStandard = NetStandard21, Platform = Net9)]
	Net9Windows,
