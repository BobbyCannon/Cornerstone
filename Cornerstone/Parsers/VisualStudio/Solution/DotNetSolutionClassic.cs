...
using Cornerstone.Parsers.VisualStudio.Solution.Classic.Parsers;
...
/// </summary>
public class DotNetSolutionClassic : IDotNetSolution
{
	#region Constructors

	/// <summary>
	/// Initializes a new instance of the <see cref="T:DotNetSolutionClassic" /> class.
	/// </summary>
	public DotNetSolutionClassic()
	{
	}
	...
	public static DotNetSolutionClassic Create(string name)
	{
		/*
		...
		*/
		...
		var response = new DotNetSolutionClassic
		{
	...
	/// <summary>
	/// Loads the <see cref="T:DotNetSolutionClassic" /> from a file path.
	/// </summary>
	/// <param name="filePath"> .NET solution file path. </param>
	/// <returns> New <see cref="T:DotNetSolutionClassic" /> instance. </returns>
	public static DotNetSolutionClassic LoadFile(string filePath)
	{
	...
	/// <param name="filePath"> .NET solution file path. </param>
	/// <returns> New <see cref="T:DotNetSolutionClassic" /> instance. </returns>
	public static DotNetSolutionClassic LoadSolution(string solutionText, string filePath)
	{
		var response = new DotNetSolutionClassic();
	...
	public void WriteTo(IStringBuffer builder)
	{
		builder.AppendLine();
		...
		foreach (var p in Projects)
		{
			...
			{
				builder.AppendLine($"\tProjectSection({s.Name}) = {SourceReflector.GetEnumDetail(s.Type).DisplayName}");
		...
		{
			builder.AppendLine($"\tGlobalSection({g.Name}) = {SourceReflector.GetEnumDetail(g.Type).DisplayName}");
