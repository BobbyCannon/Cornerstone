...
internal class DotNetSolutionProjectsParser
{
	...
	public IList<DotNetSolutionProject> Parse(DotNetSolutionClassic solution, string slnText)
	{
	...
	private DotNetSolutionProject LoadSolutionProject(DotNetSolutionClassic solution, Match match)
	{
