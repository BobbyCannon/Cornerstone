...
public class DotNetSolutionProject : DotNetProject
{
	...
	private readonly DotNetSolutionClassic _solution;
	...
	internal DotNetSolutionProject(DotNetSolutionClassic solution, string project)
	{
		_solution = solution;
	...
	private bool CheckIfSupportsPackageReferences()
	{
		...
		var isOldProject = types
			.Any(x => x is
				...
				or DotNetProjectType.SolutionFolder
			);
