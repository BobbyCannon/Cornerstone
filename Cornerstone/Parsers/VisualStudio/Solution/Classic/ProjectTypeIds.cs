...
namespace Cornerstone.Parsers.VisualStudio.Solution.Classic;
...
public static class ProjectTypeIds
{
	...
	public const string WindowsApplicationPackage = "C7167F0D-BC9F-4E6E-AFE1-012C56B48DB5";
	...
	public static string ToCodeString(Guid guid)
	{
		...
		return id switch
		{
			...
			WindowsApplicationPackage => $"{nameof(ProjectTypeIds)}.{nameof(WindowsApplicationPackage)}",
	...
	public static DotNetProjectType ToEnum(Guid projectTypeId)
	{
		...
		return id switch
		{
			...
			WindowsApplicationPackage => DotNetProjectType.WindowsApplicationPackaging,
	...
	public static string ToGuidString(DotNetProjectType type)
	{
		return type switch
		{
			...
			DotNetProjectType.WindowsApplicationPackaging => WindowsApplicationPackage,
