...
public static class QueryableExtensions
{
	...
	/// <returns> The paged results. </returns>
	public static PagedResults<T2> GetPagedResults<T1, T2>(this IQueryable<T1> query, PagedRequest request, Expression<Func<T1, T2>> transform, Expression<Func<T1, object>> order)
	{
