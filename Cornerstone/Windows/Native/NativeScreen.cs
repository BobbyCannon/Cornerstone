...
internal static class NativeScreen
{
	...
	public static HandleRef NullHandleRef = new HandleRef(null, nint.Zero);
	...
	[DllImport("user32.dll")]
	public static extern int ChangeDisplaySettingsEx(string lpszDeviceName, [In] ref DEVMODE lpDevMode, nint hwnd, int dwFlags, nint lParam);
	...
	public class MonitorEnumCallback
	{
		...
		public virtual bool Callback(nint monitor, nint hdc, nint lprcMonitor, nint lparam)
		{
