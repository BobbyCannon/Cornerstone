...
/// </summary>
public class UpdateableSettings : IncludeExcludeSettings
{
	#region Constructors
	...
	public UpdateableSettings(UpdateableAction action, IEnumerable<string> including, IEnumerable<string> excluding)
	...
	public UpdateableSettings(UpdateableAction action, IEnumerable<string> including, IEnumerable<string> excluding, bool ignoreCase)
