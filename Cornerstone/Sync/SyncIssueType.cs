...
public enum SyncIssueType
{
	...
	/// <summary>
	/// The item could not be stored due to a validation exception.
	/// </summary>
	ValidationException = 9,

	/// <summary>
	/// The sync client was not able to access the server.
	/// </summary>
	ServiceUnavailable = 10,

	/// <summary>
	/// The sync manager is disabled.
	/// </summary>
	SyncManagerDisabled = 11
}