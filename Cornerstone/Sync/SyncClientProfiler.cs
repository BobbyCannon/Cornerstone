...
public class SyncClientProfiler : CornerstoneObject, IUpdateable<SyncClientProfiler>
{
	...
	/// <summary>
	/// The overall processing time for <seealso cref="SyncClientForDatabase.GetChangeCount" />.
	/// </summary>
	...
	/// <summary>
	/// The overall processing time for <seealso cref="SyncClientForDatabase.ProcessSyncObject" />.
	/// </summary>
	public Timer ProcessSyncObject { get; }

	/// <summary>
	/// The "Added" portion of processing time for <seealso cref="SyncClientForDatabase.ProcessSyncObject" />.
	/// </summary>
	public Timer ProcessSyncObjectAdded { get; }

	/// <summary>
	/// The "Deleted" portion of processing time for <seealso cref="SyncClientForDatabase.ProcessSyncObject" />.
	/// </summary>
	public Timer ProcessSyncObjectDeleted { get; }

	/// <summary>
	/// The "Modified" portion of processing time for <seealso cref="SyncClientForDatabase.ProcessSyncObject" />.
	/// </summary>
	public Timer ProcessSyncObjectModified { get; }

	/// <summary>
	/// The "ReadEntity" portion of processing time for <seealso cref="SyncClientForDatabase.ProcessSyncObject" />.
	/// </summary>
	public Timer ProcessSyncObjectReadEntity { get; }

	/// <summary>
	/// The overall processing time for <seealso cref="SyncClientForDatabase.ProcessSyncObjects" />.
	/// </summary>
	public Timer ProcessSyncObjects { get; }

	/// <summary>
	/// The "GetDatabase" portion of processing time for <seealso cref="SyncClientForDatabase.ProcessSyncObjects" />.
	/// </summary>
	public Timer ProcessSyncObjectsGetDatabase { get; }

	/// <summary>
	/// The "SaveDatabase" portion of processing time for <seealso cref="SyncClientForDatabase.ProcessSyncObjects" />.
	/// </summary>
	public Timer ProcessSyncObjectsSaveDatabase { get; }

	/// <summary>
	/// The "SyncObjectsToList" portion of processing time for <seealso cref="SyncClientForDatabase.ProcessSyncObjects" />.
	/// </summary>
