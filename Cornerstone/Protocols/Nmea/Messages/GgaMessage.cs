...
public class GgaMessage : NmeaMessage
{
	...
	public override void Parse(string sentence)
	{
		...
		Time = System.Convert.ToDouble(GetArgument(0, "0"));
		...
		NumberOfSatellites = System.Convert.ToInt32(GetArgument(6));
		HorizontalDilutionOfPrecision = System.Convert.ToDouble(GetArgument(7, "0"));
		Altitude = System.Convert.ToDouble(GetArgument(8, "0"));
		AltitudeUnit = GetArgument(9);
		HeightOfGeoid = System.Convert.ToDouble(GetArgument(10, "0"));
