...
public class GsaMessage : NmeaMessage
{
	...
	public void AddPrn(string prn)
	{
		...
		{
			PrnsOfSatellitesUsedForFix.Add(System.Convert.ToInt32(prn));
		}
	}
	...
	public override void Parse(string sentence)
	{
		...
		PositionDilutionOfPrecision = System.Convert.ToDouble(GetArgument(14, "0"));
		HorizontalDilutionOfPrecision = System.Convert.ToDouble(GetArgument(15, "0"));
		VerticalDilutionOfPrecision = System.Convert.ToDouble(GetArgument(16, "0"));
	}
