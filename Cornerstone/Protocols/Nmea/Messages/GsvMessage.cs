...
public class GsvMessage : NmeaMessage
{
	...
	public override void Parse(string sentence)
	{
		...
		NumberOfSentences = System.Convert.ToInt32(GetArgument(0));
		SentenceNr = System.Convert.ToInt32(GetArgument(1));
		NumberOfSatellitesInView = System.Convert.ToInt32(GetArgument(2));

		var satelliteCount = GetSatelliteCount(
			System.Convert.ToInt32(NumberOfSatellitesInView),
			System.Convert.ToInt32(NumberOfSentences),
			System.Convert.ToInt32(SentenceNr));
