...
public abstract class OscCommand : Bindable
{
	...
	public int GetArgumentAsInteger(int index, int defaultValue = default)
	{
		...
		return value switch
		{
			...
			Enum eValue => System.Convert.ToInt32(eValue),
			byte bValue => bValue,
			sbyte bValue => bValue,
			char cValue => cValue,
			short sValue => sValue,
	...
	public long GetArgumentAsLong(int index, long defaultValue = default)
	{
		...
		return value switch
		{
			...
			Enum eValue => System.Convert.ToInt64(eValue),
			byte bValue => bValue,
			sbyte bValue => bValue,
			char cValue => cValue,
			short sValue => sValue,
	...
	public short GetArgumentAsShort(int index, short defaultValue = default)
	{
		...
		return value switch
		{
			...
			Enum eValue => System.Convert.ToInt16(eValue),
			byte bValue => bValue,
			sbyte bValue => bValue,
	...
	public uint GetArgumentAsUnsignedInteger(int index, uint defaultValue = default)
	{
		...
		return value switch
		{
			...
			Enum eValue => System.Convert.ToUInt32(eValue),
			byte bValue => bValue,
	...
	public ulong GetArgumentAsUnsignedLong(int index, ulong defaultValue = default)
	{
		...
		return value switch
		{
			...
			OscTimeTag time => time.Value,
			Enum eValue => System.Convert.ToUInt64(eValue),
			byte bValue => bValue,
	...
	public ushort GetArgumentAsUnsignedShort(int index, ushort defaultValue = default)
	{
		...
		return value switch
		{
			...
			Enum eValue => System.Convert.ToUInt16(eValue),
			byte bValue => bValue,
