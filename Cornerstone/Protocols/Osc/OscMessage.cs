...
public class OscMessage : OscPacket, IEnumerable<object>
{
	...
	/// <summary>
	/// Initializes an instance of an OSC message for the provided address and arguments.
	/// </summary>
	...
	public override byte[] ToByteArray()
	{
		...
		while (i < currentList.Count)
		{
			...
			switch (arg)
			{
				...
				{
					typeString += "i";
					parts.Add(OscBitConverter.GetBytes(System.Convert.ToInt32(eArg)));
					break;
				}
	...
	internal static void ArgumentsToString(StringBuilder sb, bool hex, IFormatProvider provider, IEnumerable<object> args)
	{
		...
		foreach (var obj in args)
		{
			...
			switch (obj)
			{
				...
				case Enum eValue:
				{
					sb.Append(System.Convert.ToInt32(eValue));
					break;
				}
				case IEnumerable<object> objects:
				{
