...
/// <summary>
/// </summary>
internal static class AltitudeConverter
{
	#region Constructors

	static AltitudeConverter()
	{
		GridLng = 60;
		Bottom = -90;
		GridLat = 60;
	...
	public static double ConvertHeight(double latitude, double longitude, double height, AltitudeConverterFlag flag)
	{
