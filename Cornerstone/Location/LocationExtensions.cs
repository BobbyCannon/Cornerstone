...
public static class LocationExtensions
{
	...
	/// <returns> The distance in meters. </returns>
	public static double DistanceBetween(this Cornerstone.Location.Location start, Cornerstone.Location.Location end)
	{
	...
	public static void Update(this IBasicLocation location, IBasicLocation update)
	{
		location.Update(update, null);
	}
	...
	public static bool UpdateWith(this IBasicLocation location, ILocation<IHorizontalLocation, IVerticalLocation> update, UpdateableOptions options)
	{
		...
		if ((options == null) || options.IsEmpty())
		{
			...
			location.Altitude = update.VerticalLocation.Altitude;
			location.AltitudeReference = update.VerticalLocation.AltitudeReference;
		}
		else
		{
