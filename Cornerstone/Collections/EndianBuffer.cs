...
public class LittleEndianBuffer : EndianBuffer
{
	...
	/// <summary>
	/// Initializes a little endian buffer.
	/// </summary>
...
public class BigEndianBuffer : EndianBuffer
{
	...
	/// <summary>
	/// Initializes a big endian buffer.
	/// </summary>
	/// <param name="size"> The size of the buffer. </param>
...
public abstract class EndianBuffer
{
	...
	/// <summary>
	/// Initializes a buffer order specifically for a specific endianness (byte-order). All writes and
	...
	public byte[] ReadArray(int index, int length)
	{
		...
		{
			throw new CornerstoneException("Failed to read the array.");
		}
	...
	public short ReadInt16(int index)
	{
		...
		{
			throw new CornerstoneException("Failed to read the int16 value.");
		}
	...
	public int ReadInt32(int index)
	{
		...
		{
			throw new CornerstoneException("Failed to read the int32 value.");
		}
	...
	public ushort ReadUInt16(int index)
	{
		...
		{
			throw new CornerstoneException("Failed to read the uint16 value.");
		}
	...
	{
		if (!TryReadUInt32(index, out var value))
		{
			throw new CornerstoneException("Failed to read the UInt32 value.");
		}
	...
	/// <param name="value"> The value that was read if successful. </param>
	/// <returns> True if the read was successful otherwise false. </returns>
	public bool TryReadUInt32(int index, out uint value)
	{
		var data = new byte[4];
	...
	/// <returns> True if write was successful otherwise false. </returns>
	...
	public void WriteArray(int index, byte[] value)
	{
		...
		{
			throw new CornerstoneException("Failed to write the array value.");
		}
	}
	...
	public void WriteInt16(short value)
	{
		...
		{
			throw new CornerstoneException("Failed to write the int16 value.");
		}
	}
	...
	public void WriteInt32(int value)
	{
		...
		{
			throw new CornerstoneException("Failed to write the int32 value.");
		}
	}
	...
	public void WriteInt64(long value)
	{
		...
		{
			throw new CornerstoneException("Failed to write the int64 value.");
		}
	}
	...
	public void WriteUInt16(int index, ushort value)
	{
		...
		{
			throw new CornerstoneException("Failed to write the uint16 value.");
		}
	}
	...
	public void WriteUInt32(uint value)
	{
		...
		{
			throw new CornerstoneException("Failed to write the uint32 value.");
		}
	}
