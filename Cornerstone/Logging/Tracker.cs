...
/// </summary>
public class Tracker : CornerstoneObject, IDisposable
{
	#region Constants
	...
	public Tracker(ITrackerRepository pathRepository, IDateTimeProvider dateTimeProvider)
	{
		_dateTimeProvider = dateTimeProvider;
		_session = new TrackerPath(dateTimeProvider)
		{
			Name = SessionName,
			Type = SessionName,
			Data = string.Empty
	...
	/// <summary>
	/// Run the path and complete it when done.
	/// </summary>
	...
	public static Tracker Start(ITrackerRepository repository, IDateTimeProvider timeProvider, params TrackerPathValue[] values)
	{
		var tracker = new Tracker(repository, timeProvider);
		tracker._session.Values.AddRange(values);
