...
/// </summary>
public abstract class PlatformCredentialVault : CornerstoneObject
{
	#region Fields
	...
	protected PlatformCredentialVault(IRuntimeInformation runtimeInformation)
	{
	...
	{
		return _vaultName ?? RuntimeInformation.ApplicationName.Replace(" ", "");
	}
