...
/// </summary>
public abstract class PlatformCredentialVault : Bindable
{
	#region Fields
	...
	protected PlatformCredentialVault(IRuntimeInformation runtimeInformation, IDispatcher dispatcher) : base(dispatcher)
	{
