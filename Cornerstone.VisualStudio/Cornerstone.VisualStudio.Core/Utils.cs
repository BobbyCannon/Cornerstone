...
internal static class Utils
{
	...
	private static readonly XmlReaderSettings _xmlSettings;
	...
	static Utils()
	{
		_xmlSettings = new() { DtdProcessing = DtdProcessing.Ignore };
	}
	...
	{
		return CheckAvaloniaRoot(XmlReader.Create(new StringReader(content), _xmlSettings));
	}
