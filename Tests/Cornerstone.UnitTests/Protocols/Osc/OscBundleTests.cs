...
public class OscBundleTests : CornerstoneUnitTest
{
	...
	public void ParseBundle()
	{
		...
		var expected = new OscBundle(time, new OscMessage(Now, "/message", 123, "foo", true, null), new OscMessage(Now, "/delay", 321));
	...
	{
		var time = new DateTime(2019, 1, 20, 03, 50, 12, DateTimeKind.Local);
		var expected = new OscBundle(time, new OscMessage(Now, "/message", 123, "bar", true, null), new OscMessage(Now, "/delay", 321)) { IsExtended = true };
	...
	{
		var time = new DateTime(2019, 1, 20, 03, 50, 12, DateTimeKind.Local);
		var bundle = new OscBundle(time, new OscMessage(Now, "/message", 123, "foo", true, null), new OscMessage(Now, "/delay", 321));
	...
	{
		var time = new DateTime(2019, 1, 20, 03, 50, 12, DateTimeKind.Local);
		var bundle = new OscBundle(time, new OscMessage(Now, "/message", 123, "bar", true, null), new OscMessage(Now, "/delay", 321)) { IsExtended = true };
