		...
		ProcessParseScenarios([
			(
				...
				new GnsMessage
				{
					...
					Time = 14035.00,
					Latitude = new NmeaLocation("4332.69262", "S"),
					Longitude = new NmeaLocation("17235.48549", "E"),
					ModeIndicator = "RR",
			...
			(
				...
				new GnsMessage
				{
					...
					Time = 3000,
					Latitude = new NmeaLocation("4253.65208", "N"),
					Longitude = new NmeaLocation("07852.11903", "W"),
					ModeIndicator = "DA",
