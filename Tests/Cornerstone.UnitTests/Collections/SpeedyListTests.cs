...
[TestClass]
public partial class SpeedyListTests : CornerstoneUnitTest
{
	#region Methods
	...
	{
		var list = new SpeedyList<Account>(null, new OrderBy<Account>(x => x.Name))
		{
	...
	{
		var list = new SpeedyList<int> { DistinctCheck = EqualityComparer<int>.Default };
		list.Load(1, 2, 3);
	...
	public void ManualOrderShouldReorder()
	{
		var collection = new SpeedyList<Account>
		{
			OrderBy =
			[
				new OrderBy<Account>(x => x.IsDeleted),
				new OrderBy<Account>(x => x.CreatedOn, true)
			]
		};
		...
		var client1 = new Account { Id = 1, IsDeleted = false, CreatedOn = new DateTime(2019, 8, 28, 9, 36, 43) };
		var client2 = new Account { Id = 2, IsDeleted = false, CreatedOn = new DateTime(2019, 8, 28, 9, 36, 42) };
	...
	{
		var collection = new SpeedyList<Account> { OrderBy = [new OrderBy<Account>(x => x.Name)] };
		var actual = new List<NotifyCollectionChangedEventArgs>();
	...
	public void OrderUsingManyOrderBy()
	{
		...
		for (var index = 0; index < scenarios.Count; index++)
		{
			...
			var list = new SpeedyList<Account>(scenario.order);
	...
	public void Swap()
	{
		...
		{
			new SpeedyList<int>(),
			new SpeedyList<int> { DistinctCheck = EqualityComparer<int>.Default }
		};
