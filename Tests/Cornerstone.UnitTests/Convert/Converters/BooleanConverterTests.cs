...
public class BooleanConverterTests : ConverterTests<BooleanConverter>
{
	...
	private TestScenario[] GetTestScenarios()
	{
		...
		response.AddRange(new TestScenario[]
		{
			...
			new("7: bool -> RopeBuffer<char>", false, new RopeBuffer<char>("False")),
			new("8: bool -> JsonString", true, new JsonString("True")),
			new("9: bool? -> bool", false, false),
			new("10: bool -> bool?", true, true),
			new("11: bool? -> bool?", null, typeof(bool?), null, typeof(bool?)),
			new("12: bool? -> string", null, typeof(bool?), null, typeof(string)),
			new("13: bool? -> StringBuilder", null, typeof(bool?), null, typeof(StringBuilder)),
			new("14: bool? -> TextBuilder", null, typeof(bool?), null, typeof(TextBuilder)),
			new("15: bool? -> GapBuffer<char>", null, typeof(bool?), null, typeof(GapBuffer<char>)),
			new("16: bool? -> RopeBuffer<char>", null, typeof(bool?), null, typeof(RopeBuffer<char>)),
			new("17: bool? -> JsonString", null, typeof(bool?), null, typeof(JsonString)),
			#if (!NET48)
			#endif
			// </Scenarios>
		});
