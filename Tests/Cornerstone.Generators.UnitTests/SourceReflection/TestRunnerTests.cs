...
public class TestRunnerTests : GeneratorUnitTest
{
	...
	[Test]
	public void TestRunnerBuildForNUnit()
	{
		var source = """
					using NUnit.Framework;
			...
			class Program
			{
				public static int Main(string[] args)
				{
					...
					runner.AddTest(
						new TestClassInfo {
							ClassName = "UnitTests",
							ConstructorInfo = typeof(global::Cornerstone.Test.Models.UnitTests).GetConstructor([]),
							InitializeMethod = null,
							CleanupMethod = null,
							TestMethods = [
								new TestMethodInfo {
									Name = "Test",
									MethodInfo = typeof(global::Cornerstone.Test.Models.UnitTests).GetMethod("Test"),
								}
							]
						}
					);
		...
		ValidateSource(source, expected, OutputKind.ConsoleApplication);
	}
