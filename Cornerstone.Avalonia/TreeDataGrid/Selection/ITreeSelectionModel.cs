...
/// <summary>
/// Stores and manipulates the selection state of items in a hierarchical data source.
/// </summary>
public interface ITreeSelectionModel : ITreeDataGridSelection, INotifyPropertyChanged
{
	#region Properties
	...
	/// <see cref="NotifyCollectionChangedAction.Reset" /> signal is retrieved due to e.g.
	...
	/// <summary>
	/// Occurs when a <see cref="NotifyCollectionChangedAction.Reset" /> signal is retrieved on
	/// the source data.
	/// </summary>
