...
public class TreeDataGridTextCell : TreeDataGridCell
{
	...
	{
		TextAlignmentProperty = AvaloniaProperty.RegisterDirect<TreeDataGridTextCell, TextAlignment>(nameof(TextAlignment), o => o.TextAlignment, (o, v) => o.TextAlignment = v);
		TextTrimmingProperty = AvaloniaProperty.RegisterDirect<TreeDataGridTextCell, TextTrimming>(nameof(TextTrimming), o => o.TextTrimming);
		TextWrappingProperty = AvaloniaProperty.RegisterDirect<TreeDataGridTextCell, TextWrapping>(nameof(TextWrapping), o => o.TextWrapping);
		ValueProperty = AvaloniaProperty.RegisterDirect<TreeDataGridTextCell, string>(nameof(Value), o => o.Value, (o, v) => o.Value = v);
	}
