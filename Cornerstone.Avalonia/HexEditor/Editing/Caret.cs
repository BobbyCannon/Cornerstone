...
public sealed class Caret : Bindable
{
	...
	internal Caret(HexView view) : base(view.GetDispatcher())
	{
		HexView = view;
	}
	...
	public void GoDown()
	{
		GoForward((ulong) HexView.ActualBytesPerLine);
	}
	...
	{
		GoForward((ulong) (HexView.ActualBytesPerLine * HexView.VisualLines.Count));
	}
	...
	{
		GoBackward((ulong) (HexView.ActualBytesPerLine * HexView.VisualLines.Count));
	}
	...
	public void GoToEndOfLine()
	{
		...
		var bytesPerLine = (ulong) HexView.ActualBytesPerLine;
		var byteIndex = Math.Min(((Location.ByteIndex / bytesPerLine) + 1) * bytesPerLine, HexView.Document.Length) - 1;
	...
	public void GoToStartOfLine()
	{
		...
		var bytesPerLine = (ulong) HexView.ActualBytesPerLine;
		var byteIndex = (Location.ByteIndex / bytesPerLine) * bytesPerLine;
		var bitIndex = primaryColumn.FirstBitIndex;
	...
	public void GoUp()
	{
		GoBackward((ulong) HexView.ActualBytesPerLine);
	}
