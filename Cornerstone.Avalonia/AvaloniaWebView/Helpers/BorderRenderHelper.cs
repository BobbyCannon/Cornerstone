...
namespace Cornerstone.Avalonia.AvaloniaWebView.Helpers;
...
internal class BorderRenderHelper
{
	...
	private void RenderCore(DrawingContext context, IBrush background, IBrush borderBrush, BoxShadows boxShadows,
		...
		AvaloniaList<double> borderDashArray)
	{
		...
		else
		{
			...
			if (!DoubleExtensions.IsZero(borderThickness))
			{
