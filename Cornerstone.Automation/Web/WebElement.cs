...
using Image = Cornerstone.Automation.Web.Elements.Image;
using Keyboard = Cornerstone.Automation.Web.Elements.Keyboard;
using Object = Cornerstone.Automation.Web.Elements.Object;
...
public class WebElement : Element
{
	...
	public override Point Location
	{
		get
		{
			var data = Browser.ExecuteScript($"Cornerstone.getElementLocation(\'{Id}\',{GetFrameIdInsert()});");
