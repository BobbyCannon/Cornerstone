...
namespace Cornerstone.Wpf;

/// <summary>
/// Implementation for LocationProvider
/// </summary>
public class WpfLocationProvider
	: WpfLocationProvider<Location.Location, IHorizontalLocation, IVerticalLocation, LocationProviderSettings>, ILocationProvider
{
	#region Constructors
