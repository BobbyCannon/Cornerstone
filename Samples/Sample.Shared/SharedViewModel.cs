...
public class SharedViewModel : ViewModel
{
	...
	public SharedViewModel(IRuntimeInformation runtimeInformation, IDispatcher dispatcher) : base(dispatcher)
	{
		RuntimeInformation = runtimeInformation;

		Log = new SpeedyList<string>(dispatcher) { Limit = 20 };
		//Log = new ObservableCollection<string>();
		WebClientTest = new WebClientTest(Log, dispatcher);
	...
	public WebClientTest WebClientTest { get; }
