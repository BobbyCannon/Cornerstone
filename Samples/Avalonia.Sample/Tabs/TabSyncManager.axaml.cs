...
public partial class TabSyncManager : CornerstoneUserControl
{
	...
	public TabSyncManager(IDateTimeProvider timeProvider, IRuntimeInformation runtimeInformation, IDispatcher dispatcher)
	{
		...
		SyncSession = new SyncSession(null, Guid.Empty, string.Empty, timeProvider, dispatcher);
		Progress = new ProgressTracker(dispatcher);
		RuntimeInformation = runtimeInformation;
		NumberOfItems = 1;
		TrackerRepository = new TrackerRepository(dispatcher);
		Tracker = Tracker.Start(TrackerRepository, timeProvider, dispatcher);
	...
	public TrackerRepository TrackerRepository { get; }
