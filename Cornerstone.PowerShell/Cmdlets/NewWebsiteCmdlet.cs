...
public class NewWebsiteCmdlet : PSCmdlet
{
	...
	[Parameter(HelpMessage = "The store for the certificate. Defaults to WebHosting.")]
	...
	private void UpdateBindings(Site site)
	{
		...
		foreach (var binding in bindings)
		{
			...
			{
				newBinding.CertificateHash = ssl.FromHexStringToByteArray().ToArray();
				newBinding.CertificateStoreName = CertificateStore ?? "WebHosting";
			}
