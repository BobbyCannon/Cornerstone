...
public class WindowsCredential : Credential
{
	...
	/// Create an instance of a windows credential.
	/// </summary>
	public WindowsCredential(WindowsCredentialType credentialType, string applicationName, string userName, SecureString password, string comment = null)
	{
	...
	{
		return new WindowsCredential((WindowsCredentialType) t.Type,
