...
public class WindowsInputBuilder : InputBuilder
{
	...
	/// <returns> This <see cref="InputBuilder" /> instance. </returns>
	public override InputBuilder AddMouseButtonDown(MouseButton button)
	{
	...
	/// <param name="button"> </param>
	/// <returns> This <see cref="InputBuilder" /> instance. </returns>
	public override InputBuilder AddMouseButtonUp(MouseButton button)
	{
	...
	/// <returns> This <see cref="InputBuilder" /> instance. </returns>
	public override InputBuilder AddMouseMovement(int x, int y, bool relative = true)
	{
		if (relative)
		{
			// Move relative movement of the mouse cursor
	...
	public override InputBuilder AddMouseVerticalWheelScroll(int scrollAmount)
	{
		...
		scroll.Data.Mouse.MouseData = (int) scrollAmount;
	...
	public override InputBuilder AddMouseXButtonDown(int xButtonId)
	{
		...
		buttonDown.Data.Mouse.MouseData = (int) xButtonId;
	...
	public override InputBuilder AddMouseXButtonUp(int xButtonId)
	{
		...
		buttonUp.Data.Mouse.MouseData = (int) xButtonId;
