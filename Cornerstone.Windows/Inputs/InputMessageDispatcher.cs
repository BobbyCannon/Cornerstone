...
internal class InputMessageDispatcher
{
	...
	/// <exception cref="Exception"> If any of the commands in the <paramref name="inputs" /> array could not be sent successfully. </exception>
	public void DispatchInput(params InputTypeWithData[] inputs)
	{
		if (inputs == null)
		{
