...
public class VersionStringConverter : JsonConverter<Version>
{
	...
	public override void WriteJson(JsonWriter writer, Version value, JsonSerializer serializer)
	{
		...
		writer.WritePropertyName(resolver?.GetResolvedPropertyName("Major") ?? "Major");
		writer.WriteValue(value.Major);
		writer.WritePropertyName(resolver?.GetResolvedPropertyName("Minor") ?? "Minor");
		writer.WriteValue(value.Minor);
		writer.WritePropertyName(resolver?.GetResolvedPropertyName("Build") ?? "Build");
		writer.WriteValue(value.Build);
		writer.WritePropertyName(resolver?.GetResolvedPropertyName("Revision") ?? "Revision");
