...
using System;
using System.IO;
using Cornerstone.Maui.Extensions;
...
using DeviceType = Cornerstone.Runtime.DeviceType;
...
public class MauiRuntimeInformation : RuntimeInformation
{
	...
	{
		return ApplicationIsDevelopmentBuild
			? Path.Join(FileSystem.Current.AppDataDirectory, "Development")
