...
using DevicePlatform = Cornerstone.Runtime.DevicePlatform;
...
public static class DevicePlatformExtension
{
	...
	/// <summary>
	/// Converts a Xamarin Device Platform to a Cornerstone Device Platform.
	/// </summary>
	/// <param name="platform"> The Xamarin Device Platform. </param>
	/// <returns> The Cornerstone Device Platform. </returns>
	...
	/// <summary>
	/// Converts a Cornerstone Device Platform to a Xamarin Device Platform.
	/// </summary>
	/// <param name="platform"> The Cornerstone Device Platform. </param>
