...
using Address = Cornerstone.Maui.Abstractions.Address;
...
public class GeolocatorImplementation : IGeolocator
{
	...
	private readonly object positionSync = new();
	private GeolocationSingleListener singleListener;
	...
	/// </summary>
	public static string[] ProvidersToUse { get; set; } = { };

	/// <summary>
	/// Gets or sets the location manager providers to ignore when doing
	/// continuous listening
	/// </summary>
	public static string[] ProvidersToUseWhileListening { get; set; } = { };
	...
	private List<string> ListeningProviders { get; } = new();
	...
	public async Task<IEnumerable<Address>> GetAddressesForPositionAsync(Position position, string mapKey = null)
	{
		...
		// TODO Xamarin.Forms.Maps.Geocoder is no longer supported. Use Microsoft.Maui.Devices.Sensors.Geocoding instead. For more details see https://learn.microsoft.com/en-us/dotnet/maui/migration/forms-projects#map-changes
