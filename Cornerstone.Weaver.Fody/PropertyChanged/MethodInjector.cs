...
public partial class WeaverForPropertyChanged
{
	...
	private const string InjectedEventInvokerName = "<>OnPropertyChanged";
	...
	private MethodDefinition GetMethodDefinition(TypeDefinition targetType, out InvokerTypes invokerType)
	{
	...
	{
		var method = new MethodDefinition(InjectedEventInvokerName, GetMethodAttributes(targetType), ModuleWeaver.TypeSystem.VoidReference);
	...
	private MethodDefinition InjectMethod(TypeDefinition targetType, out InvokerTypes invokerType)
	{
