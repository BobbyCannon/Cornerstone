...
partial class WebView2Core
{
	...
	private void ReparentController(CoreWebView2Controller coreWebView2Controller, IntPtr hwnd, bool sync = true)
	{
	...
	private void ResetWebViewSize(CoreWebView2Controller coreWebView2Controller)
	{
		...
		coreWebView2Controller.Bounds = new Rectangle(0, 0, System.Convert.ToInt32(_handler.Bounds.Width * scale), System.Convert.ToInt32(_handler.Bounds.Height * scale));
